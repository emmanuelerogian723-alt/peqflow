...
class Settings:
    # Core
    APP_NAME: str = "Peqflow"
    APP_VERSION: str = "1.0.0"
    ENVIRONMENT: str = os.getenv("ENVIRONMENT", "development")
    SECRET_KEY: str = os.getenv("PEQFLOW_SECRET_KEY", "dev-secret-change-me")
    ...
    MCP_AUTH_TOKEN: str = os.getenv("MCP_AUTH_TOKEN", "peqflow-mcp-auth-dev")
